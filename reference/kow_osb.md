...
- Minima: `f = 3.07505...e-4`; and `f = 1.02734...e-3` at
  `(Inf, -14.07..., -Inf, -Inf)`.

## Note

The Hessian is undefined when a denominator in its formula is exactly
zero, so `he()` raises an error at that parameter value.
