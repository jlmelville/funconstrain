...
- Minima: `f = 2.24997...e-5` if `n = 4`; `f = 7.08765...e-5` if
  `n = 10`. The returned `fmin` and `xmin` describe the `n = 4` example.
...
Gill, P. E., Murray, W., & Pitfield, R. A. (1972). *The implementation
of two revised quasi-Newton algorithms for unconstrained optimization*
(Report NAC-11). Teddington, London: National Physical Laboratory,
