...
**Dimensions:** $n\ge1$, $m\ge n$; default $n=50$ and $m=n$<br>
...
Calling `chebyquad()` derives $m=n$ from the parameter-vector length. Pass an
explicit `m` to the factory to use an overdetermined instance with $m>n$.
