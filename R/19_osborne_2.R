  ...
  list(
    ...
    he = function(par) {
      ...
      for (i in 1:m) {
        ...
        h[6, 9] <- h[6, 9] +
          4.0 * s1 * (t1 - x9) * x2 * d2 * ((t1 - x9)^2 * x6 - 1.0)
        h[9, 9] <- h[9, 9] -
          4.0 * s1 * x6 * x2 * d2 * (2.0 * (t1 - x9)^2 * x6 - 1.0)
        h[3, 10] <- h[3, 10] - 4.0 * s1 * (t1 - x10) * x7 * d3
        h[7, 10] <- h[7, 10] +
          4.0 * s1 * x3 * (t1 - x10) * d3 * ((t1 - x10)^2 * x7 - 1.0)
        h[10, 10] <- h[10, 10] -
          4.0 * s1 * x7 * x3 * d3 * (2.0 * (t1 - x10)^2 * x7 - 1.0)
        h[4, 11] <- h[4, 11] - 4.0 * s1 * (t1 - x11) * x8 * d4
        h[8, 11] <- h[8, 11] +
          4.0 * s1 * x4 * (t1 - x11) * d4 * ((t1 - x11)^2 * x8 - 1.0)
        h[11, 11] <- h[11, 11] -
          4.0 * s1 * x8 * x4 * d4 * (2.0 * (t1 - x11)^2 * x8 - 1.0)
      }
      for (j in 1:10) {
        for (k in (j + 1):11) {
          h[k, j] <- h[j, k]
