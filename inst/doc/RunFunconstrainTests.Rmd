...
text file to specify which test functions are to be applied to which solvers.
Moreover, a "sink" function name can be specified to save the text output of the
run. 
...
the function numbers. Appendix A lists the numbers and corresponding names.
