...
test_that("Gradient is zero at stated minima", {
  ...
  expect_equal(testfun$gr(min_x2), rep(0, 2), tolerance = 1e-3)
  expect_equal(testfun$gr(min_x3), rep(0, 3), tolerance = 1e-3)
  expect_equal(testfun$gr(min_x4), rep(0, 4), tolerance = 1e-3)
  expect_equal(testfun$gr(min_x5), rep(0, 5), tolerance = 1e-3)
  expect_equal(testfun$gr(min_x6), rep(0, 6), tolerance = 1e-3)
  expect_equal(testfun$gr(min_x7), rep(0, 7), tolerance = 1e-3)
  expect_equal(testfun$gr(min_x8), rep(0, 8), tolerance = 1e-3)
  expect_equal(testfun$gr(min_x9), rep(0, 9), tolerance = 1e-3)
  expect_equal(testfun$gr(min_x10), rep(0, 10), tolerance = 1e-3)
})
test_that("Function value is correct at stated minima", {
  expect_equal(testfun$fn(min_x1), min_fx, tolerance = 1e-6)
  expect_equal(testfun$fn(min_x2), min_fx, tolerance = 1e-6)
  expect_equal(testfun$fn(min_x3), min_fx, tolerance = 1e-6)
  expect_equal(testfun$fn(min_x4), min_fx, tolerance = 1e-6)
