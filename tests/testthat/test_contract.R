test_that("factory contract list covers all exported problem factories", {
  exported_factories <- setdiff(getNamespaceExports("funconstrain"),
                                c("fufn", "fufnrun"))
...
test_that("current m metadata is recorded without making it a core field", {
  expected <- data.frame(
    ...
    m_type = c(
      NA, "logical", NA, NA, NA, "logical", NA, NA, NA, "logical",
      NA, NA, NA, NA, "logical", NA, NA, NA, "logical", NA,
      "double", "double", "double", NA, NA, NA, NA, NA, "logical", NA,
      "logical", "double", NA, NA, NA
    ),
    m_value = c(
